...
function getWindSpeedString(map, options, e) {
    var pos = map.containerPointToLatLng(L$1.point(e.containerPoint.x, e.containerPoint.y));
...
export { ExtendedLControl, degreesToCardinalDirection, extendedLControl, getWindSpeedString, meterSec2Knots, meterSec2kilometerHour, meterSec2milesHour, vectorToDegrees, vectorToSpeed, velocityLayer };
